  ...
  return (
    <div>
      ...
      <main className="w-screen h-screen flex flex-col justify-center items-center bg-gray-800">
        <div className="shadow-lg bg-white space-y-8 flex flex-col py-8 px-16 w-screen lg:w-[400px] h-screen md:h-[450px] lg:rounded-2xl">
          <h2 className="text-3xl mb-8 font-bold border-b pb-4">Login</h2>
          <input
